...
export const DESCRIPTION = "Brevo marketing and messaging for agents - contacts, lists, campaigns, transactional email and SMS, CRM deals, senders, and webhooks over the Brevo v3 API";
...
function withContext(command) {
    return (args) => command(args, getCommandContext());
}
